...
class Rectangle:
    """Defines a rectangle with width and height, and methods to compute
    area, perimeter, and print the rectangle."""
    ...
    def __repr__(self):
        ...
        of the rectangle instance for debugging purposes."""
