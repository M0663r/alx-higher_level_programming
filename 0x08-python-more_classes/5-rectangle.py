...
print the rectangle using the character '#', and handle deletion of instances.
The class also provides __repr__ to recreate a new instance via eval().
"""


class Rectangle:
    """Defines a rectangle w, perimeter, and print the rectangle."""
    ...
    def __str__(self):
        """Returns a string representation of the rectanglethe character '#'.
    ...
    def __repr__(self):
        """Returns a string the rectanto recrnew instance using eval()."""
